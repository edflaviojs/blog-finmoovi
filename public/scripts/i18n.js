...
const translations = {
  pt: {
    ...
    'footer.copyright': `© ${new Date().getFullYear()} FinMoovi. Todos os direitos reservados.`,
  ...
  en: {
    ...
    'footer.cookies': 'Cookies',
    'footer.copyright': `© ${new Date().getFullYear()} FinMoovi. All rights reserved.`,
  ...
  es: {
    ...
    'footer.cookies': 'Cookies',
    'footer.copyright': `© ${new Date().getFullYear()} FinMoovi. Todos los derechos reservados.`,
