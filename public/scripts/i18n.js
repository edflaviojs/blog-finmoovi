// Client-side i18n — Auto-generated by scripts/generate-i18n-client.js
...
const translations = {
  "pt": {
    ...
    "sidebar.newsletter.desc": "Receba dicas de finanças pessoais toda semana no seu email.",
    ...
    "cta.desc": "Multi-moeda (BRL, USD, EUR). Smart Capture por voz e OCR. Relatórios inteligentes com IA.",
    "cta.feature1": "✓ Multi-moeda (BRL, USD, EUR)",
    "cta.feature2": "✓ Smart Capture por voz e OCR",
    "cta.feature3": "✓ Relatórios inteligentes com IA",
    "cta.feature4": "✓ 100% offline e seguro",
    "cta.btn": "Experimentar Grátis — 7 dias",
    "cta.note": "Sem cartão de crédito. Cancele quando quiser.",
    "footer.desc": "Dicas práticas de finanças pessoais, controle de gastos e educação financeira para organizar sua vida.",
    ...
    "footer.copyright": "© 2026 FinMoovi. Todos os direitos reservados.",
    ...
    "sobre.subtitle": "Educação financeira acessível",
  ...
  "en": {
    ...
    "sidebar.newsletter.desc": "Get weekly personal finance tips delivered to your inbox.",
    ...
    "cta.desc": "Multi-currency (BRL, USD, EUR). Voice & OCR Smart Capture. AI-powered smart reports.",
    "cta.feature1": "✓ Multi-currency (BRL, USD, EUR)",
    "cta.feature2": "✓ Voice & OCR Smart Capture",
    "cta.feature3": "✓ AI-powered smart reports",
    "cta.feature4": "✓ 100% offline & secure",
    "cta.btn": "Try Free — 7 days",
    "cta.note": "No credit card required. Cancel anytime.",
    "footer.desc": "Practical personal finance tips, expense tracking and financial education to organize your life.",
    ...
    "footer.cookies": "Cookies",
    "footer.copyright": "© 2026 FinMoovi. All rights reserved.",
    ...
    "footer.link.baixar": "Get FinMoovi",
    ...
    "sobre.subtitle": "Accessible financial education",
  ...
  "es": {
    ...
    "section.verTodos": "Ver todos",
    "sidebar.newsletter.title": "Newsletter Gratuita",
    "sidebar.newsletter.desc": "Recibe consejos de finanzas personales cada semana en tu email.",
    ...
    "cta.desc": "Multi-moneda (BRL, USD, EUR). Smart Capture por voz y OCR. Reportes inteligentes con IA.",
    "cta.feature1": "✓ Multi-moneda (BRL, USD, EUR)",
    "cta.feature2": "✓ Smart Capture por voz y OCR",
    "cta.feature3": "✓ Reportes inteligentes con IA",
    "cta.feature4": "✓ 100% offline y seguro",
    "cta.btn": "Probar Gratis — 7 días",
    "cta.note": "Sin tarjeta de crédito. Cancela cuando quieras.",
    "footer.desc": "Consejos prácticos de finanzas personales, control de gastos y educación financiera para organizar tu vida.",
    ...
    "footer.cookies": "Cookies",
    "footer.copyright": "© 2026 FinMoovi. Todos los derechos reservados.",
    ...
    "sobre.title": "Acerca del FinMoovi Blog",
    "sobre.subtitle": "Educación financiera accesible",
