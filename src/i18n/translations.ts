...
export const translations: Record<Lang, Record<string, string>> = {
  pt: {
    ...
    'ferramentas.amortizacao.title': 'Simulador de Amortização',
    'ferramentas.amortizacao.desc': 'Reduzir o prazo ou a parcela? Veja a diferença em reais antes de decidir.',
    'ferramentas.desconto.title': 'Calculadora de Desconto',
    'ferramentas.desconto.desc': 'Quanto você paga, quanto economiza, e por que dois descontos não somam.',
    'ferramentas.rachar.title': 'Rachar a Conta',
    'ferramentas.rachar.desc': 'Divida a conta com gorjeta, sem quem não bebeu pagar a bebida dos outros.',
    'ferramentas.ir.title': 'IR sobre Investimentos',
    'ferramentas.ir.desc': 'Quanto sobra do rendimento depois do imposto — e em que dia a alíquota cai.',
  ...
  en: {
    ...
    'ferramentas.amortizacao.title': 'Early Repayment Simulator',
    'ferramentas.amortizacao.desc': 'Shorten the term or lower the instalment? See the difference in money before deciding.',
    'ferramentas.desconto.title': 'Discount Calculator',
    'ferramentas.desconto.desc': 'What you pay, what you save, and why two discounts never add up.',
    'ferramentas.rachar.title': 'Split the Bill',
    'ferramentas.rachar.desc': 'Split the bill with tip, without non-drinkers paying for other people’s drinks.',
    'ferramentas.ir.title': 'Investment Income Tax',
    'ferramentas.ir.desc': 'What is left of your yield after Brazilian income tax — and the day the rate drops.',
  ...
  es: {
    ...
    'ferramentas.amortizacao.title': 'Simulador de Amortización',
    'ferramentas.amortizacao.desc': '¿Reducir el plazo o la cuota? Mira la diferencia en dinero antes de decidir.',
    'ferramentas.desconto.title': 'Calculadora de Descuento',
    'ferramentas.desconto.desc': 'Cuánto pagas, cuánto ahorras, y por qué dos descuentos nunca se suman.',
    'ferramentas.rachar.title': 'Dividir la Cuenta',
    'ferramentas.rachar.desc': 'Divide la cuenta con propina, sin que quien no bebió pague la bebida de los demás.',
    'ferramentas.ir.title': 'Impuesto sobre Inversiones',
    'ferramentas.ir.desc': 'Cuánto queda del rendimiento después del impuesto — y el día en que la tasa baja.',
