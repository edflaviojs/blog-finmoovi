...
`;
  ...
  try {
    ...
    // derrubou a corrida de 02/09/2026). O porquê todo em seo-guard.js.
    if (skipSeTituloCanibaliza(slugPt, 'investimentos', POSTS_DIR, title)) return;
    ...
    if (queueEntry) markUsed(queueEntry.keyword, 'gerar-post-investimentos');
