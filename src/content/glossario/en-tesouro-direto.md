---
term: "tesouro direto"
definition: "Understand what tesouro direto is, how it works, advantages, risks and practical examples of application in the Brazilian financial market."
...
seo:
  metaTitle: "tesouro direto - Financial Glossary"
  metaDescription: "Understand what tesouro direto is, how it works, advantages, risks and practical examples of application in the Brazilian financial market."
  keywords: ["tesouro direto", "glossário", "finanças", "glossary", "finance", "brazil"]
---

## What it is
O Tesouro Direto é um programa criado pelo governo brasileiro que permite que os cidadãos invistam diretamente em títulos públicos, como LTNs (Letras do Tesouro Nacional) e NTNs (Notas do Tesouro Nacional). Esses títulos são basicamente empréstimos que você faz ao governo, que, em troca, paga juros sobre o valor investido. É uma forma de aplicar seu dinheiro de maneira segura e rentável, pois os títulos são garantidos pelo governo.
...
* LTNs: São títulos com prazos mais curtos, geralmente de 1 a 5 anos, e oferecem taxas de juros fixas.
* NTNs: São títulos com prazos mais longos, que podem variar de 5 a 10 anos, e também oferecem taxas de juros fixas, mas podem ter correção pelo IPCA (Índice de Preços ao Consumidor Amplo), que ajuda a proteger o valor do investimento contra a inflação.
...
* Diversificação: O Tesouro Direto pode ser uma boa opção para diversificar sua carteira de investimentos, reduzindo a dependência de apenas um tipo de aplicação.
...
## Risks
Embora o Tesouro Direto seja considerado uma aplicação de baixo risco, existem alguns fatores a considerar:
* Risco de crédito: Embora baixo, existe o risco de que o governo não honre seus compromissos.
* Risco de inflação: Se a inflação subir, o poder de compra do dinheiro investido pode diminuir.
* Risco de liquidez: Se você precisar do dinheiro antes do vencimento do título, pode não conseguir vendê-lo pelo valor nominal ou pode perder parte dos juros.

## Practical examples
Vamos considerar um exemplo prático. João tem um salário de R$ 6.000 por mês e decide investir R$ 1.000 por mês no Tesouro Direto. Com uma taxa de juros anual de 9%, após 1 ano, João terá investido R$ 12.000 e terá ganhado cerca de R$ 1.080 em juros, totalizando R$ 13.080. **Practical tip:** Invista regularmente para aproveitar o efeito dos juros compostos.

Outro exemplo é de Maria, que tem um salário de R$ 4.000 por mês e decide investir R$ 500 por mês. Com uma taxa de juros anual de 8%, após 2 anos, Maria terá investido R$ 12.000 e terá ganhado cerca de R$ 1.920 em juros, totalizando R$ 13.920.

## Start today
Não perca mais tempo e comece a investir no Tesouro Direto hoje mesmo. Com a facilidade de compra e venda de títulos pela internet, você pode começar com um valor mínimo e aumentar seus investimentos ao longo do tempo. Lembre-se de que a chave para o sucesso nos investimentos é a disciplina e a paciência. **Practical tip:** Use um aplicativo de investimentos para facilitar o processo de compra e venda de títulos e para acompanhar seus investimentos de forma fácil e prática. Invista com sabedoria e veja seu patrimônio crescer ao longo do tempo.
