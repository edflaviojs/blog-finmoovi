...
LC es la sigla de **Letra de Cambio** — un título de [renta fija](/es/glossario/es-renta-fija) emitido por **financieras**, no por bancos.

Funciona igual que un [certificados de depósito](/es/glossario/es-cdb): prestas dinero a la institución por un plazo determinado y ella te devuelve con [intereses](/es/glossario/es-interes). La diferencia está en quién pide prestado.
...
- Eliges una LC con plazo y tasa definidos (por ejemplo, 115% del [tasa interbancaria](/es/glossario/es-cdi))
...
Lo que nivela el juego es el **[fondo de garantía](/es/glossario/es-garantia-fgc)**: si la financiera quiebra, el fondo devuelve tu dinero hasta el límite garantizado, por contribuyente y por institución — la misma cobertura que tiene un certificado de depósito.
