...
definition: "Entenda o que é venda a descoberto, como funciona, vantagens, riscos e exemplos práticos de aplicação no mercado financeiro brasileiro."
title: "venda a descoberto - Glossário Financeiro"
description: "Entenda o que é venda a descoberto, como funciona, vantagens, riscos e exemplos práticos de aplicação no mercado financeiro brasileiro."
image: "/images/glossario/venda-a-descoberto.webp"
imageAlt: "moedas empilhadas e em jarra de vidro com planta, em fundo escuro."
category: "basico"
tags: ["venda a descoberto", "glossário", "finanças"]
author: "FinMoovi"
...
seo:
  metaTitle: "venda a descoberto - Glossário Financeiro"
  metaDescription: "Entenda o que é venda a descoberto, como funciona, vantagens, riscos e exemplos práticos de aplicação no mercado financeiro brasileiro."
  keywords: ["venda a descoberto", "glossário", "finanças"]
---

## O que é

Venda a descoberto, também chamada de “short selling”, é quando você vende um ativo que **não possui** na sua carteira, esperando que o preço caia para recomprá‑lo mais barato. Funciona como um empréstimo: você pega a ação de alguém, vende hoje e, se tudo sair como o planejado, compra de volta depois por um valor menor, devolve ao dono original e fica com a diferença. É uma estratégia usada por investidores que acreditam que o mercado vai cair, mas exige atenção porque o risco pode ser maior que o valor investido.

![O que é](/images/glossario/venda-a-descoberto-inline-1.webp)
...
A venda a descoberto pode ser uma ferramenta útil para diversificar sua estratégia de investimento. Entre os principais benefícios, destacam‑se:

![Vantagens](/images/glossario/venda-a-descoberto-inline-3.webp)
...
Imagine que você ganha R$5.000 por mês e tem R$20.000 investidos. Você acredita que as ações da empresa X, cotadas a R$50, vão cair nas próximas semanas. Veja como a venda a descoberto pode funcionar:

- **Cenário de queda**: você vende a descoberto 200 ações (R$50 × 200 = R$10.000). Três semanas depois, o preço cai para R$40. Você recompra 200 ações por R$8.000, devolve ao credor e fica com R$2.000 de lucro (menos custos).  
- **Cenário de alta**: se o preço subir para R$60, você precisará comprar as 200 ações por R$12.000, resultando em R$2.000 de prejuízo (novamente, menos custos).  

Outro exemplo: um colega seu, que recebe R$8.000 mensais, usou a estratégia para proteger sua carteira de ações de tecnologia. Ele vendeu a descoberto 100 ações de uma empresa que estava supervalorizada (R$120 cada). Quando o setor sofreu uma correção e o preço caiu para R$90, ele recomprou e garantiu R$3.000 de lucro, que serviu para compensar a queda de outras posições.

## Como começar

Se você decidiu experimentar a venda a descoberto, siga estes passos para iniciar de forma segura:
