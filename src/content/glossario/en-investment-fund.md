...
## How it works
When you invest in a fund, you are basically buying a piece of that fund. The [valor](/en/glossario/en-financial-value) of your piece is calculated based on the total value of the fund and the number of pieces you purchased. Funds are managed by specialized companies that charge an [taxa](/en/glossario/en-financial-fee) administration fee to run the fund. This fee is usually a percentage of the fund’s total value.
