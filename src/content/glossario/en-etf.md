---
term: "etf"
definition: "Understand what etf is, how it works, advantages, risks and practical examples of application in the Brazilian financial market."
...
imageAlt: "Gold coins stacked in ascending order with green sprouts and a jar of coins on dark background."
category: "basico"
...
seo:
  metaTitle: "etf - Financial Glossary"
  metaDescription: "Understand what etf is, how it works, advantages, risks and practical examples of application in the Brazilian financial market."
  keywords: ["etf", "glossário", "finanças", "glossary", "finance", "brazil"]
---

## What it is
The ETF, or Exchange‑Traded Fund, is a type of investment that allows investors to buy a basket of assets, such as [stocks](/en/glossario/en-stocks), bonds or commodities, in a single transaction. This means that instead of buying each asset individually, you can acquire a share of a fund that already holds them, simplifying the whole process. Imagine you want to invest in a diversified portfolio of stocks from the [stock exchange](/en/glossario/en-bolsa-de-valores), but you don’t have the time or knowledge to pick which stocks to buy. An ETF can be the perfect solution, as it offers an easy and accessible way to invest in a variety of assets.
...
## Advantages
ETFs offer several advantages for investors, especially for those who are just starting out. **Practical tip:** One of the main advantages of ETFs is [diversification](/en/glossario/en-diversification), as they allow investors to buy a basket of assets with a single investment. In addition, ETFs are generally cheaper than mutual funds because they have lower management fees. Another advantage is flexibility, as ETFs can be traded in real time, allowing investors to adjust their portfolios quickly.
...
In addition, ETFs can be affected by changes in [interest](/en/glossario/en-interest) rates, inflation and other economic conditions. It’s important to remember that ETFs are long‑term investments, and having a clear, disciplined investment strategy is crucial to achieving your goals.

## Practical examples
Let’s consider a practical example. Imagine you earn $1,000 per month and want to invest 10 % of your income in a domestic stock ETF. You could invest $100 per month in an ETF that tracks a major local index, for instance. **Practical tip:** It’s important to remember that diversifying your investment portfolio is essential, so you might consider investing in different types of ETFs, such as a bond ETF or a commodities ETF.

Another example is a person who earns $600 per month and wants to invest in a foreign‑company stock ETF. They could invest $60 per month in an ETF that tracks the S&P 500 index, for example. **Practical tip:** It’s important to remember that ETFs can be an accessible way to invest in assets that are otherwise hard to reach, so thorough research before investing is essential.
