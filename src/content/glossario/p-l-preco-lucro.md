...
![Introdução ao P/L](/images/glossario/p-l-preco-lucro-inline-1.webp)



## Exemplos Práticos
Vamos considerar dois exemplos para entender melhor como o P/L funciona:

- **Exemplo 1:** Uma empresa de tecnologia tem um preço de ação de R$ 200,00 e um lucro por ação de R$ 20,00. O P/L seria de 10 (200 / 20 = 10).
- **Exemplo 2:** Uma empresa de varejo tem um preço de ação de R$ 80,00 e um lucro por ação de R$ 8,00. O P/L também seria de 10 (80 / 8 = 10).

![Exemplos Práticos](/images/glossario/p-l-preco-lucro-inline-3.webp)
...
| Empresa | Preço de Ação (R$) | Lucro por Ação (R$) | P/L |
| --- | --- | --- | --- |
...
Para ficar por dentro das suas finanças e monitorar o desempenho de suas [ações](/glossario/acoes), considere usar um aplicativo de [gestão financeira](/posts/5-alternativas-ao-mobills-em-2026). Esses aplicativos podem ajudá-lo a acompanhar o preço de suas ações, calcular o P/L e muito mais, tornando mais fácil tomar decisões inteligentes sobre seus investimentos.
