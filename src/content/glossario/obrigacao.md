---
term: "obrigação"
definition: "O que é obrigação e como isso aparece no seu dia a dia — explicado de forma simples, com um jeito prático de acompanhar no FinMoovi."
...
seo:
  metaTitle: "obrigação - Glossário Financeiro"
  metaDescription: "O que é obrigação e como isso aparece no seu dia a dia — explicado de forma simples, com um jeito prático de acompanhar no FinMoovi."
  keywords: ["obrigação", "glossário", "finanças"]
---
...
1. Abra o FinMoovi e, na tela inicial, toque em “Adicionar obrigação”.
2. Use a câmera para fotografar o boleto ou fatura que acabou de chegar.
3. Confirme a categoria sugerida (por exemplo, “cartão de crédito”) e ajuste a data de vencimento se necessário.
4. Defina um lembrete 3 dias antes do vencimento e salve.
