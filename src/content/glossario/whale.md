---
term: "whale"
definition: "O que é whale e como isso aparece no seu dia a dia — explicado de forma simples, com um jeito prático de acompanhar no FinMoovi."
...
seo:
  metaTitle: "whale - Glossário Financeiro"
  metaDescription: "O que é whale e como isso aparece no seu dia a dia — explicado de forma simples, com um jeito prático de acompanhar no FinMoovi."
  keywords: ["whale", "glossário", "finanças"]
---
...
![O que é um “whale” no mundo financeiro  ](/images/glossario/whale-inline-1.webp)
...
## Como reconhecer o comportamento de um whale nas suas finanças pessoais  
A primeira pista costuma aparecer nos extratos: um valor que equivale a “cerca de um aluguel” ou “o preço de um café por dia, mas multiplicado por 30”. Outros sinais são:  
...
Se você notar que um único item está consumindo a maior parte da sua margem de segurança, provavelmente está lidando com um whale.

## Ferramentas do FinMoovi que ajudam a domar os whales  
O FinMoovi foi pensado para transformar esses picos em informação clara e acionável. Veja como cada funcionalidade entra em cena:  
...
- **Lembretes e alertas de saldo**: notificação quando o saldo da conta ficar abaixo de um valor que você considera “seguro”.  
- **Offline / PWA / sincronização**: mesmo sem internet, você registra as despesas; quando conectar, tudo se atualiza automaticamente.  

Com esses recursos, o whale perde a capacidade de “esconder” o valor e você ganha visibilidade para agir antes que ele desequilibre o orçamento.
...
Além disso, aproveite a captura inteligente: ao registrar a nota de um jantar caro, o app já classifica como “lazer” e atualiza o total da categoria, permitindo que você veja instantaneamente o impacto no seu orçamento.

## Comece hoje  
Reserve cinco minutos agora: abra o FinMoovi, tire uma foto da última nota fiscal que você tem em mãos e deixe o app categorizar automaticamente. Em seguida, vá em “Planejamento mensal”, defina um limite para a categoria “lazer” equivalente a “duas vezes o preço de um café por dia” e ative o alerta de saldo. Pronto, você já deu o primeiro passo para manter os whales sob controle.
