---
term: "zero coupon"
definition: "Understand what zero coupon is, how it works, advantages, risks and practical examples of application in the Brazilian financial market."
...
imageAlt: "Gold coins stacked in ascending order beside a glass piggy bank with a green sprout, on a pink surface against a dark blue background."
category: "basico"
...
seo:
  metaTitle: "zero coupon - Financial Glossary"
  metaDescription: "Understand what zero coupon is, how it works, advantages, risks and practical examples of application in the Brazilian financial market."
  keywords: ["zero coupon", "glossário", "finanças", "glossary", "finance", "brazil"]
---
...
## Risks
However, zero coupons also have some risks. One is credit risk, which I mentioned earlier. Another is [inflation](/en/glossario/en-inflation) risk, which can erode the real value of the money you’ll receive at maturity. Additionally, zero coupons can have liquidity risk, i.e., the risk that you cannot sell the security before maturity.
