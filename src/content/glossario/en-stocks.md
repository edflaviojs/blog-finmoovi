...
imageAlt: "Gold coins stacked in ascending order with green plants, orange bars, and glass jar."
category: "basico"
...
seo:
  metaTitle: "ações - Financial Glossary"
  metaDescription: "Understand what ações is, how it works, advantages, risks and practical examples of application in the Brazilian financial market."
  keywords: ["ações", "glossário", "finanças", "glossary", "finance", "brazil"]
---
...
* **[Dividends](/en/glossario/en-dividends)**: payments made by the company to shareholders, usually annually, as a way of distributing profits.
