---
term: "usura"
definition: "Entenda o que é usura, como funciona, vantagens, riscos e exemplos práticos de aplicação no mercado financeiro brasileiro."
...
readingTime: 5
locale: "pt"
translationKey: "glossario-usura"
seo:
  metaTitle: "usura - Glossário Financeiro"
  metaDescription: "Entenda o que é usura, como funciona, vantagens, riscos e exemplos práticos de aplicação no mercado financeiro brasileiro."
  keywords: ["usura", "glossário", "finanças"]
---

## O que é
O termo "usura" refere-se à prática de emprestar [dinheiro](/posts/cashback-inteligente) a [juros](/glossario/juros) excessivos, muitas vezes de forma abusiva. Isso significa que o [valor](/glossario/valor-financeiro) dos juros é tão alto que torna difícil para o devedor pagar a dívida. No Brasil, a usura é considerada ilegal e é regulamentada pelo Código Penal, que define como usura a cobrança de juros acima de 12% ao ano.
...
## Como funciona
A usura funciona de forma que o credor cobra juros altos sobre o valor emprestado, o que pode levar o devedor a uma situação de endividamento crônico. Por exemplo, se alguém toma um empréstimo de R$ 10.000 com juros de 20% ao ano, o valor total a ser pago será de R$ 12.000 no primeiro ano, considerando apenas os juros. Isso significa que o devedor precisará pagar R$ 2.000 apenas em juros, além do valor principal do empréstimo.

Além disso, a usura pode ser disfarçada em diferentes formas, como taxas de abertura, taxas de manutenção, entre outras. É importante ler atentamente o contrato antes de assinar e entender todos os termos e condições. **Dica prática:** sempre peça uma cópia do contrato e leia-o cuidadosamente antes de assinar.

## Vantagens
Embora a usura seja ilegal e prejudicial, existem algumas vantagens em entender como ela funciona. Por exemplo, saber como a usura funciona pode ajudar as pessoas a evitar situações de endividamento crônico. Além disso, entender como a usura funciona pode ajudar a identificar oportunidades de empréstimos mais justos e transparentes.

 Algumas das vantagens de evitar a usura incluem:
* Menores taxas de juros
* Mais flexibilidade nos pagamentos
* Mais transparência nos contratos
* Menos risco de endividamento crônico

![Vantagens](/images/glossario/usura-inline-3.webp)
