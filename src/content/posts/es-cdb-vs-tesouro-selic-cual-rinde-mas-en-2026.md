...
El certificado de depósito es un tipo de [inversión](/es/posts/es-montando-cartera-diversificada-con-r-500) de renta fija ofrecida por bancos e instituciones financieras. Funciona como un préstamo que usted hace al banco, y a [cambio](/es/glossario/es-cambio), el banco paga una tasa de interés. El certificado de depósito puede ser pre‑fijado, post‑fijado o híbrido, cada uno con su propia forma de calcular los intereses.
