...
seo:
  metaTitle: "ETFs: o que são e como investir de forma simples e rentável"
  metaDescription: "Descubra o que são ETFs, como funcionam, vantagens e cuidados. Veja exemplos práticos e dê os primeiros passos para investir com segurança e diversificação."
  keywords: ["ETFs","investimento em fundos","bolsa de valores","diversificação","risco e retorno","carteira de investimentos","finanças pessoais","etf o que é","como investir etf","etf para iniciantes"]
---

## O que são ETFs

[ETF](/glossario/etf) é a sigla para **Exchange Traded Fund**, ou Fundo de Índice negociado em bolsa. Em termos simples, um ETF reúne um conjunto de ativos – [ações](/glossario/acoes), títulos, commodities – e reproduz o desempenho de um índice, como o Ibovespa ou o S&P 500. Cada cota do ETF pode ser comprada ou vendida na bolsa como se fosse uma ação comum, o que traz praticidade e [liquidez](/glossario/liquidez).

> **Primeira aparição:** “ETF” (Exchange Traded Fund) – fundo que replica um índice e é negociado como ação.

## Como funciona na prática

Quando você compra 10 cotas de um ETF que replica o Ibovespa, está, na prática, investindo em todas as empresas que compõem esse índice (na mesma proporção). Se o Ibovespa subir 2 %, o [valor](/glossario/valor-financeiro) das suas cotas também sobe aproximadamente 2 %.
...
Imagine que você investe **R$1.000** em um ETF que replica o índice de [renda fixa](/glossario/renda-fixa), com rentabilidade média de 6 % ao ano. Em um ano, seu investimento renderia:
...
| **Custos menores** | Taxas de administração costumam ser de 0,2 % a 0,5 % ao ano, bem abaixo de [fundos](/glossario/fundo-de-investimento) de gestão ativa. |
...
> **Dica:** antes de comprar, verifique se o ETF está registrado na **[CVM](https://www.cvm.gov.br)** e se o prospecto está disponível para consulta.
...
<!-- SCHEMA_AUTO:{"@context":"https://schema.org","@type":"HowTo","name":"ETFs: o que são e como investir de forma simples e rentável","step":[{"@type":"HowToStep","position":1,"name":"Abra uma conta em corretora – escolha uma que ofereça [taxa](/glossario/taxa-financeira) de corretagem zero ou reduzida para ETFs.","text":"Abra uma conta em corretora – escolha uma que ofereça [taxa](/glossario/taxa-financeira) de corretagem zero ou reduzida para ETFs."},{"@type":"HowToStep","position":2,"name":"Defina o objetivo – se o foco é longo prazo, um ETF de ações pode ser adequado; para [renda fixa](/posts/renda-fixa-vs-renda-variavel-qual-vale-mais-a-pena-em-2026), procure ETFs que acompanhem o [CDI](/glossario/cdi) ou o [Tesouro Selic](/posts/cdb-vs-tesouro-selic-qual-rende-mais-em-2026).","text":"Defina o objetivo – se o foco é longo prazo, um ETF de ações pode ser adequado; para [renda fixa](/posts/renda-fixa-vs-renda-variavel-qual-vale-mais-a-pena-em-2026), procure ETFs que acompanhem o [CDI"},{"@type":"HowToStep","position":3,"name":"Monte um plano de aporte – por exemplo, investir R$500 todo mês em um ETF de ações brasileiras.","text":"Monte um plano de aporte – por exemplo, investir R$500 todo mês em um ETF de ações brasileiras."},{"@type":"HowToStep","position":4,"name":"Faça a ordem de compra – selecione o ticker (código) do ETF, informe a quantidade e confirme a operação.","text":"Faça a ordem de compra – selecione o ticker (código) do ETF, informe a quantidade e confirme a operação."},{"@type":"HowToStep","position":5,"name":"Acompanhe a performance – use relatórios mensais ou um [app de finanças](/posts/planilha-de-gastos-quando-ela-deixa-de-funcionar) para ver como seu [investimento](/posts/tesouro-direto-para-iniciantes) evolui.","text":"Como começar a investir/images/posts/etfs-o-que-sao-e-como-investir-de-forma-simples-e-rentavel-4.webp"},{"@type":"HowToStep","position":6,"name":"Escolha o ETF que mais combina com seu objetivo (ações, renda fixa, setores).","text":"Escolha o ETF que mais combina com seu objetivo (ações, renda fixa, setores)."},{"@type":"HowToStep","position":7,"name":"Abra a conta em uma corretora que ofereça ferramentas de acompanhamento, como relatórios de posição e gráficos.","text":"Abra a conta em uma corretora que ofereça ferramentas de acompanhamento, como relatórios de posição e gráficos."},{"@type":"HowToStep","position":8,"name":"Defina um aporte – comece com R$500 ou menos e aumente gradualmente conforme seu [orçamento](/posts/5-alternativas-ao-mobills-em-2026) permite.","text":"Defina um aporte – comece com R$500 ou menos e aumente gradualmente conforme seu [orçamento](/posts/5-alternativas-ao-mobills-em-2026) permite."}]} -->
