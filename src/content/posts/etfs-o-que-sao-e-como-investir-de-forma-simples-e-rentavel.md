...
*Simulação feita com [juros compostos](/glossario/juros-compostos) mensais, sem considerar impostos ou taxas de corretagem.*
...
- **Impostos** – Ganhos são tributados em 15 % para operações de [renda variável](/glossario/renda-variavel), e há isenção para vendas até R$20.000 mensais.
...
3. **Defina um aporte** – comece com R$500 ou menos e aumente gradualmente conforme seu [orçamento](/posts/5-alternativas-ao-mobills-em-2026) permite.
