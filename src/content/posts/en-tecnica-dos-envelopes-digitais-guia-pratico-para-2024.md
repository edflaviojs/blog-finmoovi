...
1. **Choose an app** – Use a [personal finance](/en/posts/en-30-day-rule-for-purchases) app that lets you create “categories” or “envelopes”. Popular examples are [Mobills](/en/posts/en-5-alternativas-ao-mobills-em-2026) and [FinMoovi](https://finmoovi.com).  
2. **Create the categories** – Start with the five most basic ones:  
   - Food  
   - Transportation  
   - Housing (rent, condo, utilities)  
   - Leisure/Entertainment  
   - Emergency Reserve  
3. **Set monthly limits** – Base them on your income. See the table below for three salary profiles.
...
## Allocating income to the categories
...
3. **Reserve the money right away** – If the app lets you “lock” or “mark as saved”, do it. That way you won’t spend what should stay in the emergency reserve.

This process takes less than 5 minutes and leaves your [budget](/en/posts/en-5-dicas-para-reorganizar-suas-financas-nas-ferias) “ready to use”.

## Monitoring and adjusting spending

1. **Record every expense** – Whether on your phone, computer, or even by voice assistant.  
2. **Check the balance** – When an envelope gets close to zero, the app will send a notification.  
3. **Reallocate if needed** – If you spent less on leisure, transfer the surplus to the reserve or to pay debts.
...
> **Important:** Consult official sources such as the [Central Bank of Brazil](https://www.bcb.gov.br) to understand interest‑rate limits and fees that may affect your budget.
...
3. **Plan the next round** – If the food envelope was 15 % over, consider reducing the allocation or looking for [alternatives](/en/posts/en-5-alternativas-ao-organizze-em-2026-opcoes-para-gerenciar-su) (farmers’ markets, bulk purchases).
...
With just 5 minutes daily, you keep total control and still have time to enjoy life.
