...
seo:
  ...
  keywords: ["Tesouro Direto","investimento","renda fixa","títulos públicos","financeira pessoal","economia","tesouro direto iniciante","como investir tesouro direto","tesouro selic"]
---
...
Outra vantagem é a [liquidez](/glossario/liquidez). Você pode resgatar seus títulos antes do vencimento, embora possa haver perda de juros. Isso é útil se você precisar do dinheiro antes do prazo.
...
## Tipos de Títulos
Existem vários tipos de títulos disponíveis no Tesouro Direto, cada um com suas características e prazos. Alguns dos mais comuns incluem:
...
## Riscos
Embora o Tesouro Direto seja considerado um investimento de baixo risco, existem alguns riscos a considerar:
...
Aqui está uma tabela com a simulação de rendimento:

| Ano | Valor Investido | Juros | Valor Acumulado |
| --- | --- | --- | --- |
...
Se você decidir investir no Tesouro Direto, é importante ler atentamente as condições e prazos de cada título antes de investir. Além disso, é recomendável diversificar seus investimentos para minimizar os riscos.
