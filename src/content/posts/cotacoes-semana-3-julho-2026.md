...
imageAlt: "Notebook e monitor com gráficos coloridos, xícara de café e plantas em mesa."
category: cotacoes
tags:
  - cotações
  - dólar
...
### Dólar (USD/BRL)  
O real ganhou alguns centavos frente ao dólar, que recuou 0,83 % ao longo da semana. O movimento foi impulsionado por duas coisas:  
...
### Euro (EUR/BRL)  
O euro também recuou na mesma janela, 0,58 %, terminando em R$ 5,84 — movimento na mesma direção do dólar, o que sugere que a força veio do lado do real, e não de cada moeda em separado.
