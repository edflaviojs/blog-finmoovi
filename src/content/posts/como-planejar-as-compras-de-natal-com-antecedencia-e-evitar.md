...
### 1. Defina o “teto” de gastos antes de qualquer compra
Antes de sair correndo para as lojas (ou para a internet), estabeleça quanto você está disposto a gastar no total. Não precisa de números precisos; pense em termos de “cerca de dois aluguéis” ou “o equivalente a um salário mínimo”. Esse valor será seu **teto**.

1. **Abra o FinMoovi** → vá em *Planejamento Mensal* → crie uma meta chamada “Natal 2026” com o teto definido.
2. **Ative o alerta de limite**: o app avisa quando o total das compras cadastradas se aproximar do teto.

### 2. Crie a lista mestre de presentes e eventos
A maioria das despesas natalinas vem de duas fontes: **presentes** e **eventos** (ceia, decoração, viagens). Separe-as em duas categorias dentro do FinMoovi:
...
1. **Certeza** – O que realmente precisa ser comprado? (ex.: presente obrigatório para avó)
2. **Conveniência** – O que pode ser substituído por algo mais barato ou feito em casa? (ex.: decorações DIY)
3. **Custo‑benefício** – O que traz mais alegria por menos dinheiro? (ex.: um livro em promoção ao invés de um brinquedo caro)
...
Esses lembretes evitam compras de última hora, que costumam ser mais caras e impulsivas.

### 6. Controle o impulso na hora da compra
Quando estiver no caixa ou na página de checkout, o FinMoovi exibe um **resumo rápido**: “Você já está a 70 % do seu teto de Natal”. Esse pequeno detalhe psicológico reduz a chance de adicionar itens desnecessários.
...
### 8. Revise semanalmente – o ritual de 15 minutos
Dedique, ao menos, **15 minutos por semana** para revisar a lista de Natal no FinMoovi:
...
### 9. Compartilhe a lista com a família
...
1. Abra o app e vá em **Modo Compras**.
2. Tire uma foto da sua lista de presentes (ou digite rapidamente).
3. Defina o **teto** como “cerca de dois aluguéis”.
4. Ative o **alerta de limite** e o **resumo de total em tempo real**.
5. Salve e pronto – você já tem o panorama completo das despesas natalinas!

---

### Conclusão
Planejar as compras de Natal com antecedência não precisa ser um bicho de sete cabeças. Ao transformar a lista de presentes e eventos em dados visualizados no FinMoovi, você ganha clareza, controla o impulso e distribui os gastos ao longo dos meses, garantindo que o espírito festivo chegue sem apertos financeiros.
