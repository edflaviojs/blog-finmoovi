...
Gerado em: 2026-08-14T09:05:10.186Z
Propriedade: https://blog.finmoovi.com/

## Resumo

- **539/613** URLs indexadas
- **74** não indexadas
- **0** com erro na inspeção
- **48** página(s) de conteúdo fora do índice há ≥7 dias
...
- Duplicate, Google chose different canonical than user: 10
...
- `https://blog.finmoovi.com/posts/como-garantir-financiamento-para-seus-projetos-sem-dor-de/` — Duplicate, Google chose different canonical than user (desde 2026-08-07)
...
- `https://blog.finmoovi.com/glossario/bolsa-de-valores/` — URL is unknown to Google (desde 2026-07-30)
...
- `https://blog.finmoovi.com/glossario/juros-compostos/` — Discovered - currently not indexed (desde 2026-07-30)
- `https://blog.finmoovi.com/glossario/juros/` — Discovered - currently not indexed (desde 2026-07-30)
- `https://blog.finmoovi.com/glossario/margem-de-lucro/` — Discovered - currently not indexed (desde 2026-07-30)
...
- `https://blog.finmoovi.com/en/glossario/en-leverage/` — URL is unknown to Google (desde 2026-07-30)
...
- `https://blog.finmoovi.com/es/glossario/es-consorcio/` — Discovered - currently not indexed (desde 2026-07-30)
...
- `https://blog.finmoovi.com/es/glossario/es-kyc/` — Discovered - currently not indexed (desde 2026-07-30)
- `https://blog.finmoovi.com/es/glossario/es-lc/` — Discovered - currently not indexed (desde 2026-07-30)
- `https://blog.finmoovi.com/es/glossario/es-usura/` — Discovered - currently not indexed (desde 2026-07-30)